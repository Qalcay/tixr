...
const INDEX_MATRIX: usize = 24;
//const INDEX_MATRIX: usize = (1 << 13) - 1;
//const INDEX_MATRIX: usize = 8192;

const HISTOGRAPHY: usize = (1 << 13); // 2**13 = 8192, cannot use 2^13 it is bitwise op
...
const INDEX_TO_PRINTER: usize = 64;

const PLOT_ASPECT_RATIO: f32 = 2.92; // 2.4, higher is wider!

const FORCE_TICK_RATE: u64 = 7;
...
const DRIFT_RANGE: (f32, f32) = (-0.00011112, 0.00022223); // 0.00015 .. 0.00025
const VOLUME_RANGE: (f32, f32) = (0.002768, 0.022223); // 0.003 .. 0.018
const BETA_RANGE: (f32, f32) = (0.33334, 1.98765); // 0.4 .. 1.8
const LIQUID_RANGE: (f32, f32) = (0.0999998, 1.0); // 0.25 .. 1.0
const SENTIMENT_RANGE: (f32, f32) = (-0.19876, 0.19876); // -0.2 .. 0.2

const ECONOMY_BASE: f32 = 24.898; // 10.0
const ECONOMY_PERCENTAGE: f32 = 234.0; // 250.0
const ECONOMY_DRIVER: f32 = 0.12345; // 0.10

const STEP_DELAY: u64 = 33;
const STEP_DELAY_F32: f32 = 11.0;
const STEP_LOCK_MOTION: f32 = 222.0; // 0.0
const TENSE_1: f32 = 10001.0; // 0.01 .. at 200.0 SLM set to 20000.0 to grant equal effect
const TENSE_2: f32 = 30003.0; // 0.002
const TENSE_3: f32 = 50005.0; // 0.005
const RELAX_1: f32 = 6006.0; // 0.08
const RELAX_2: f32 = 3003.0; // 0.04
const RELAX_3: f32 = 2002.0; // 0.01
const FLOW_ZEN: f32 = 0.50001; // 0.60
const FLOW_BLISS: f32 = 0.66667; // 1.0
const FLOW_TUMULT: f32 = 1.3334; // 1.8
const FLOW_CHAOS: f32 = 2.9998; // 3.8
...
const ACCOUNT_BALANCE: f64 = 0.0;
const PAYOUT_DECAY_RATE: f32 = 1.0 / HISTOGRAPHY;

const QUOTIANT_HI: u64 = 0xFFFC_FFFB_FFFA_FFF0; // 0xFFFC_FFFB_FFFA_FFF0
const QUOTIANT_LO: u64 = 0x987_0987_0987_0987; // 0x0987_0987_0987_0987
...
struct UserTradingAccount {
    total_balance: f64,
    current_position: Option<UserPosition>,
}
